-- =============================================================================
-- Thakkar Medico — V50: Fix Delivery Auto-Assignment on Field Orders
--
-- Recreates public.place_order to correctly implement setting
-- v_assigned_to := v_caller_id when the order is created by a delivery user.
-- =============================================================================
