...
const getStatusConfig = (colors: AppColors): Record<OrderStatus, { color: string; icon: keyof typeof Ionicons.glyphMap; label: string }> => ({
  ...
  out_for_delivery: { color: '#26A69A', icon: 'car', label: 'Out For Delivery' },
  in_transit: { color: '#00ACC1', icon: 'navigate', label: 'In Transit' },
  arriving_soon: { color: '#43A047', icon: 'notifications', label: 'Arriving Soon' },
  processing: { color: '#1E88E5', icon: 'sync', label: 'Processing' },
